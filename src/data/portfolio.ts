...
export const portfolio: Record<Locale, PortfolioContent> = {
  ...
  fa: {
    ...
    meta: {
      ...
      description:
        'متخصص سیستم و زیرساخت در مشهد با سابقه کار از سال ۱۳۹۸ در شبکه، مجازی‌سازی، VoIP، Odoo و خودکارسازی کارهای تکراری.',
      image: '/og/portfolio-fa.png',
    },
    navigation: [
      { href: '#case-studies', label: 'نمونه‌کارها' },
      { href: '#experience', label: 'سوابق' },
      { href: '#capabilities', label: 'مهارت‌ها' },
    ...
    hero: {
      ...
      statement: 'مشکل را پیدا می‌کنم و سیستم را به کار برمی‌گردانم.',
      introduction:
        'از سال ۱۳۹۸ در حوزه زیرساخت کار کرده‌ام؛ از سرور و VMware تا VoIP و Odoo. تمرکزم روی عیب‌یابی، پایداری سرویس و حل مشکل کاربران بوده است.',
    },
    metrics: [
      { value: '۵۰۰', label: 'کاربر در بزرگ‌ترین محیط ERP که پشتیبانی کرده‌ام' },
      { value: 'بیش از ۲۰۰', label: 'محیط مشتری در سرویس مرکز تماس ابری' },
      { value: 'بیش از ۲۰', label: 'سرور Linux و Windows تحت پشتیبانی' },
      { value: '۶–۷', label: 'درخواست پیچیده در یک روز کاری معمول' },
    ],
    sectionCopy: {
      caseStudies: {
        eyebrow: 'نمونه‌های کاری',
        title: 'چند نمونه از کار واقعی',
        description:
          'نام شرکت‌ها حذف شده، اما مقیاس، ابزار و نتیجه هر کار مشخص است.',
      },
      experience: {
        eyebrow: 'مسیر حرفه‌ای',
        title: 'از Helpdesk تا زیرساخت و ERP',
        description: 'تجربه کاری من از پشتیبانی کاربران شروع شد و به شبکه، VoIP، پایگاه داده و Odoo رسید.',
      },
      capabilities: {
        eyebrow: 'مهارت‌های فنی',
        title: 'ابزارها و حوزه‌های کاری من',
        description:
          'ابزارها بخشی از کارند؛ مهارت اصلی من پیدا کردن مشکل بین لایه‌های مختلف و ساده‌تر کردن نگهداری سیستم است.',
      },
      projects: {
        eyebrow: 'پروژه‌های شخصی',
        title: 'پروژه‌هایی که ساخته‌ام',
        description:
          'دو پروژه برای کار بیشتر با معماری نرم‌افزار، API و خودکارسازی در کنار تجربه زیرساختی.',
      },
      credentials: { eyebrow: 'سوابق تکمیلی', title: 'تحصیلات، مدرک فنی و زبان‌ها' },
      contact: {
        eyebrow: 'همکاری',
        title: 'برای همکاری صحبت کنیم',
        description:
          'برای موقعیت‌های دورکار سیستم و زیرساخت در دسترس هستم؛ به‌ویژه جایی که عیب‌یابی دقیق، پایداری سرویس و ارتباط روشن مهم باشد.',
      },
    },
    caseLabels: { challenge: 'مسئله', action: 'کاری که انجام دادم', outcome: 'نتیجه' },
    caseStudies: [
      {
        id: 'erp-operations',
        category: 'Odoo و ERP',
        title: 'فرایند تایید انتقال انبار را بدون ماژول اختصاصی پیاده کردم',
        summary:
          'چند محیط Odoo 15 و 17 را پشتیبانی و شخصی‌سازی کردم؛ از تیم‌های کوچک تا یک مجموعه با حدود ۵۰۰ کاربر.',
        challenge:
          'انتقال بین انبارها باید جداگانه به تایید فرستنده و گیرنده می‌رسید تا جابه‌جایی بدون مجوز در هر مرحله متوقف شود.',
        action:
          'فرم‌ها، فیلدها، گزارش‌ها، خودکارسازی‌ها، سطح دسترسی و تایید دومرحله‌ای را فقط با Odoo Studio ساختم.',
        outcome:
          'فرایند موردنیاز بدون ساخت ماژول اختصاصی اجرا شد؛ در کنار این کار، روزانه ۶ تا ۷ درخواست پیچیده پشتیبانی را هم حل می‌کردم.',
      ...
      },
      {
        ...
        title: 'از زیرساخت مرکز تماس با بیش از ۲۰۰ محیط مشتری پشتیبانی کردم',
        summary:
          'این سرویس مرکز تماس ابری روی VMware، Linux، Windows و Asterisk اجرا می‌شد.',
        challenge:
          'بیش از ۲۰۰ محیط جداگانه مشتری به سرویس صوت، شبکه و ماشین‌های مجازی وابسته بودند.',
        action:
          'سرویس‌ها را پایش می‌کردم، ماشین مجازی می‌ساختم، مسیرهای تماس را نگهداری می‌کردم و مشکل‌ها را بین VMware، Asterisk، MikroTik و Cisco دنبال می‌کردم.',
        outcome:
          'سرویس روزانه پایدار ماند و ظرفیت لازم برای مشتری‌های جدید هم فراهم شد؛ هم‌زمان از استقرار در هتل‌ها، مجتمع‌های مسکونی و مراکز خدماتی پشتیبانی کردم.',
        metric: { value: 'بیش از ۲۰۰', label: 'محیط مشتری تحت پشتیبانی' },
        technologies: ['VMware', 'Asterisk', 'Issabel', 'SIP', 'MikroTik', 'Cisco'],
      },
      {
        id: 'virtualization',
        category: 'مجازی‌سازی',
        title: 'شش سرور فیزیکی را به حدود هشت ماشین مجازی منتقل کردم',
        summary:
          'سرویس‌های پراکنده را به VMware ESXi منتقل کردم تا نگهداری زیرساخت ساده‌تر شود.',
        challenge:
          'شش سرور فیزیکی نگهداری را سخت‌تر کرده بودند و مدیریت سرویس‌ها بین چند دستگاه پخش بود.',
        action:
          'برای مهاجرت P2V برنامه‌ریزی کردم، سرویس‌ها را جابه‌جا کردم و حدود هشت ماشین مجازی را در ESXi سامان دادم.',
        outcome:
          'تعداد سرورهای فیزیکی کمتر شد و نگهداری، پایش و برنامه بازیابی متمرکزتر شد.',
        metric: { value: '۶ سرور', label: 'تبدیل‌شده به حدود ۸ ماشین مجازی' },
        technologies: ['VMware ESXi', 'P2V', 'Windows Server', 'Linux', 'Backup Planning'],
      },
    ],
    experience: [
      {
        ...
        organization: 'شرکت راهکارهای ERP · نام شرکت منتشر نشده',
        role: 'کارشناس پشتیبانی نرم‌افزار و Odoo',
        summary: 'پشتیبانی و شخصی‌سازی چند محیط Odoo و راهنمایی کاربران را برعهده داشتم.',
        highlights: [
          'شخصی‌سازی فرایندهای انبار، فروش، خرید، حسابداری و CRM با Odoo Studio.',
          'مشکل‌های نرم‌افزار، فرایند، دسترسی و پایگاه داده را در محیط‌هایی تا حدود ۵۰۰ کاربر حل می‌کردم.',
          'نیازهای کاری را به فرم، گزارش، خودکارسازی و سطح دسترسی تبدیل می‌کردم.',
        ],
        technologies: ['Odoo', 'Odoo Studio', 'SQL', 'ERP Support'],
      },
      {
        ...
        organization: 'شرکت نرم‌افزار مالی · نام شرکت منتشر نشده',
      ...
      },
      {
        ...
        organization: 'شرکت ارتباطات ابری · نام شرکت منتشر نشده',
        role: 'کارشناس پشتیبانی VoIP و شبکه',
        summary: 'سرور، ماشین مجازی، شبکه و سرویس صوت یک مرکز تماس ابری را نگهداری می‌کردم.',
        highlights: [
      ...
      },
      {
        ...
        organization: 'شرکت خدمات فناوری اطلاعات · نام شرکت منتشر نشده',
    ...
    capabilities: [
      {
        ...
        description: 'نگهداری محیط‌های ترکیبی سرور و ساده‌تر کردن زیرساخت.',
        technologies: ['Linux', 'Windows Server', 'VMware ESXi', 'Docker', 'Virtual Machines'],
      },
      {
        title: 'شبکه',
        description: 'پیدا کردن مشکل‌های اتصال و شبکه، از سیستم کاربر تا تجهیزات لبه.',
        technologies: ['MikroTik', 'Cisco', 'VLAN', 'NAT', 'Firewall', 'VPN', 'LAN/WAN'],
      },
      {
        title: 'VoIP',
      ...
      {
        title: 'ERP و عملیات',
        description: 'تبدیل قواعد کسب‌وکار به فرایند و دسترسی‌هایی که نگهداری‌شان ساده باشد.',
        technologies: ['Odoo 15/17', 'Odoo Studio', 'CRM', 'Inventory', 'Sales', 'Accounting'],
      },
      {
    ...
    projects: [
      {
        ...
        description:
          'یک کتابخانه ویدیویی محلی با API در Go، رابط React، پایگاه داده SQLite، پردازش FFmpeg، استقرار Docker و پخش HTTP Range.',
        url: 'https://github.com/mahdim43/videonest-go',
        technologies: ['Go', 'React', 'TypeScript', 'Docker', 'SQLite', 'FFmpeg'],
      },
      {
        ...
        description:
          'ابزاری دوزبانه برای گسترش یک ایده اولیه که خروجی‌ها را دسته‌بندی، رتبه‌بندی و نقد می‌کند.',
        url: 'https://github.com/mahdim43/idea-expander',
        technologies: ['AI Workflows', 'Prompt Design', 'English / Persian', 'Collaboration'],
      },
    ],
    credentials: {
      education: {
        ...
        detail: 'دانشگاه ازاد اسلامی، مشهد',
        period: '2021 — 2023',
      },
      certification: {
        label: 'گواهی‌نامه',
    ...
    contact: {
      location: 'مشهد، ایران',
      availability: 'برای همکاری دورکار در حوزه سیستم و زیرساخت در دسترس هستم',
      email: shared.email,
      github: shared.github,
      linkedin: shared.linkedin,
    },
